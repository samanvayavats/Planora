...
import { Sparkles, Mail, Lock, Eye, EyeOff, ArrowRight, Loader2, CheckCircle2 } from "lucide-react";
  ...
  return (
    <div className="relative w-full max-w-md rounded-3xl border-2 border-slate-900 bg-slate-950 p-8 shadow-2xl shadow-slate-950 sm:p-10 my-6">
      ...
      <div className="text-center space-y-2">
        ...
        <h1 className="pt-2 text-2xl font-bold font-playfair text-white sm:text-3xl">Sign In</h1>
      ...
      <form onSubmit={handleSubmit(onSubmit)} className="mt-6 space-y-4">
        ...
        {/* Escaped apostrophe and corrected link text */}
